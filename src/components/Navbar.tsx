...
export default function Navbar() {
  ...
  return (
    ...
    >
      <div className="flex justify-between items-center max-w-[1440px] mx-auto px-10 max-[950px]:px-5 max-[480px]:px-4 h-[80px] max-[950px]:h-[64px] max-[480px]:h-[56px]">
        {/* Logo */}
        <Link href="/" className="flex items-center shrink-0">
          <img
            src="/images/logo-new-white.png"
            alt="Precision Contractors"
            className="h-[38px] max-[950px]:h-[32px] max-[480px]:h-[28px] w-auto"
          />
        </Link>
