        ...
        <div className="flex justify-between gap-12 max-[950px]:flex-wrap max-[768px]:gap-10">
          ...
          <div className="flex flex-col gap-5 max-w-[320px] max-[950px]:max-w-full max-[950px]:min-w-[280px]">
            ...
            <div className="flex gap-3 mt-1">
              ...
              <a href="https://wa.me/201007625526" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-white/[0.04] border border-white/[0.06] flex items-center justify-center text-white/40 transition-all duration-300 hover:text-white hover:border-primary/40 hover:bg-primary/10" aria-label="WhatsApp">
